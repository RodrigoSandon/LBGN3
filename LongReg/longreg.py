...
def main():
    ...
    MASTER_RAW_PATH = r"/media/rory/Padlock_DT/BLA_Analysis"  # Change ideally, so that you won't have to repeat calcium preprocessing
    MICE_PATHS_IN_RAW = [
            ...
            for mouse in os.listdir(BATCH_PATH):
                if "BLA" in mouse:
                    ...
                    try:
                        ...
                        # GETTING THOSE CELLS ONLY ABOVE ncc score of above 0.9 | above 0.7 6/10/22
                        mod_longreg_df = util.preprocess_longreg_results(
                            meta_csv_filename, 0.70, roots
                        )
