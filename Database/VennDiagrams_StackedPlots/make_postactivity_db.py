...
def main():
    ...
    db_name = "/media/rory/Padlock_DT/BLA_Analysis/Database/BLA_Cells_Post_Activity.db"
    ...
    for session in lst:
        ...
        csvs = find_paths_startswith(SESSION_PATH, "all_concat_cells_z_fullwindow_id_auc_bonf0.05.csv")
