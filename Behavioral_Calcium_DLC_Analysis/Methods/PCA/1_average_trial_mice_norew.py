        ...
        for s in shock:
            for mouse in mice:
                for session in sessions:
                    ...
                    ROOT = f"/media/rory/Padlock_DT/BLA_Analysis/Decoding/{parent_dir}/{block}/{s}/{mouse}/{session}"
                    ...
                    try:
                        ...
                        #print(avg_df.head())
                        #print(avg_df.shape)
                        avg_df.to_csv(os.path.join(parent, outfile))
