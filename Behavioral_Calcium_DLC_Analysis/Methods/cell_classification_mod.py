...
class CellClassification(Utilities):
    ...
    def wilcoxon_rank_sum(self):  # wilcoxon rank sum test
        ...
        Utilities.pie_chart(
            ...
            list(d.values()),
            list(d.keys()),
            replace_name=f"{replace_name_prefix}_0-2s_-10-0s_bonf_pie_manwhitney_02232022.png",
        )
...
def main():
    ...
    CONCAT_CELLS_PATH = r"/media/rory/Padlock_DT/BLA_Analysis/BetweenMiceAlignmentData/RDT D1/Shock Ocurred_Choice Time (s)/False/all_concat_cells_zbaseline-10_0_gauss1.5_z_avgs.csv"
