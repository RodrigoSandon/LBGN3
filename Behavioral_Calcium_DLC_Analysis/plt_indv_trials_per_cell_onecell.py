...
def main():
    ...
    session = "RDT D1"
    csv = "/media/rory/Padlock_DT/BLA_Analysis/PTP_Inscopix_#5/BLA-Insc-15/RDT D1/SingleCellAlignmentData/C11/Block_Reward Size_Shock Ocurred_Choice Time (s)/(1.0, 'Large', False)/plot_ready_z_fullwindow.csv"
