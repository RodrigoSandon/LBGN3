...
def main():
    experiment_types = ["Conditioning", "Extinction", "Retrieval"]
    ...
    #hex_color = mcolors.to_hex((random.random(), random.random(), random.random()))
    ...
    for experiment_type in experiment_types:
        ...
        ending_file_looking_for = "FreezingOutput_processed.csv"
        ...
        #list_of_freezing_props_all_mice = []

        num_mice = 0
        for file in os.listdir(ROOT):
            if ending_file_looking_for in file:
                #print(file)
